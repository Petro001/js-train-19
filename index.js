...
let Book = {
  ...
  read: function () {
    console.log(
      `Ви читаєте ${this.title} від ${this.author}`,
    )
  },
}
...
console.log(Novel.hasOwnProperty(Novel))
...
Object.defineProperty(ScienceBook, 'Info', {
  ...
  get() {
    return `Про книгу ${this.title}:${this_info}`
  },
})
...
;(Media.artist = 'Загальний Виконавець'),
  (Media.title = 'Загальна Пісня'),
